...
<Library LVVersion="19008000">
	...
	<Item Name="Create ZIP Step.lvclass" Type="LVClass" URL="../Create ZIP Step/Create ZIP Step.lvclass"/>
	<Item Name="ZIP Item.lvclass" Type="LVClass" URL="../ZIP Item/ZIP Item.lvclass"/>
	<Item Name="ZIP Model.ctl" Type="VI" URL="../ZIP Model.ctl">
